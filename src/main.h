...
static const uint256 hashGenesisBlock("0x00000e95eda26ced69bcda5d4794e153c54b2a7edb7752439a7c5d376238c7e0");
...
public:
    ...
    {
        // fluttercoin: the coin stake transaction is marked with the first output empty
...
public:
    ...
    // fluttercoin: block signature - signed by one of the coin base txout[N]'s owner
    ...
    // fluttercoin: entropy bit for stake modifier if chosen by modifier
    ...
    // fluttercoin: two types of block: proof-of-work or proof-of-stake
    ...
    // fluttercoin: get max transaction timestamp
    ...
    bool AcceptBlock();
    bool GetCoinAge(uint64& nCoinAge) const; // fluttercoin: calculate total coin age spent in block
...
public:
    ...
    unsigned int nFile;
    unsigned int nBlockPos;
    uint256 nChainTrust; // fluttercoin: trust score of block chain
    int nHeight;

    int64 nMint;
    int64 nMoneySupply;

    unsigned int nFlags;  // fluttercoin: block index flags
    enum
    {
